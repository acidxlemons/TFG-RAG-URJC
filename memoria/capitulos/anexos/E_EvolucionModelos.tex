...
3 & Qwen 2.5 7B (base)                    & Dic 2025 (evaluación) & 32\,K & $\sim$8\,GB & \textit{Model loop}: tokens de parada incompatibles \\
...
\paragraph{Etapa 3 --- Qwen 2.5 7B base (evaluación, diciembre 2025).}
...
\end{tikzpicture}
\vspace{0.4em}
\caption[Diagrama general de las tecnologías utilizadas en el sistema.]{Diagrama general de las tecnologías utilizadas en el sistema. La disposición apaisada separa el flujo de consulta, la lógica propia del TFG, las integraciones externas y la capa de observabilidad en bloques legibles.}
