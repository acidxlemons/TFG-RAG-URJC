...
Antes de describir en detalle qué hace el sistema, conviene ver su aspecto real. La Figura~\ref{fig:screenshot-openwebui} muestra JARVIS en funcionamiento: una interfaz de chat en el navegador donde el usuario formula su pregunta en lenguaje natural y recibe la respuesta acompañada de las fuentes documentales utilizadas.
