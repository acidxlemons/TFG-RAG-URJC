...
\begin{itemize}
    \item \textbf{Repositorio (GitHub):} \url{https://github.com/acidxlemons/TFG-RAG-URJC} --- código de los microservicios, definición de la arquitectura Docker, configuración de los modelos locales y documentación de despliegue.
    \item \textbf{Página del proyecto (GitHub Pages):} \url{https://acidxlemons.github.io/TFG-RAG-URJC/} --- \textit{landing page} con la descripción del sistema, capturas reales y un vídeo de demostración que recorre la aplicación en funcionamiento.
\end{itemize}
