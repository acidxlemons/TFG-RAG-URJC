...
% ============================================================
\section{Código y recursos del proyecto}
...
\begin{itemize}
    \item \textbf{Repositorio de código en GitHub}\footnote{\url{https://github.com/acidxlemons/TFG-RAG-URJC}}: código de los microservicios, definición de la arquitectura Docker, configuración de los modelos locales y documentación de despliegue.
    \item \textbf{Página del proyecto en GitHub Pages}\footnote{\url{https://acidxlemons.github.io/TFG-RAG-URJC/}}: \textit{landing page} con la descripción del sistema, capturas reales y un vídeo de demostración que recorre la aplicación en funcionamiento.
\end{itemize}
...
\begin{itemize}
    ...
    \item Reutilización de OpenWebUI como interfaz conversacional e integración de su autenticación con el proveedor corporativo de identidad mediante OpenID Connect (OIDC) sobre Azure AD, es decir, inicio de sesión único corporativo (SSO, \textit{Single Sign-On}).
...
\begin{itemize}
    \item \textit{Requisitos hardware}: el sistema requiere una GPU NVIDIA con suficiente VRAM (memoria de vídeo de la tarjeta gráfica) para mantener un rendimiento aceptable en tareas de OCR e inferencia local.
...
\begin{enumerate}
    ...
    \item La publicación del sistema como proyecto de código abierto, acompañado de una página web de presentación y de documentación para su despliegue reproducible. Las direcciones del repositorio y de la página del proyecto se recogen al final del Capítulo~\ref{cap:conclusiones}.
\end{enumerate}
...
El \textbf{Capítulo~\ref{cap:metodologia}} describe la metodología seguida: el proceso de desarrollo, los sprints en detalle ---con sus tareas, decisiones tecnológicas y lecciones aprendidas--- y el uso de herramientas de inteligencia artificial como apoyo.
...
Por último, el \textbf{Capítulo~\ref{cap:conclusiones}} recoge las conclusiones: el grado de consecución de los objetivos, el balance tecnológico y de esfuerzo del proyecto, los conocimientos aplicados y adquiridos, las líneas futuras de trabajo y las direcciones públicas del código y de la página web del proyecto.
