...
\begin{enumerate}
    ...
    \item La publicación del sistema como proyecto de código abierto en GitHub\footnote{\url{https://github.com/acidxlemons/TFG-RAG-URJC}}, con documentación para despliegue reproducible.
\end{enumerate}
